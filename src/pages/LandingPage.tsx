            ...
            <div className="hidden lg:block relative perspective-1000">
              <div className="transform rotate-y-[-10deg] rotate-x-[5deg] shadow-2xl rounded-2xl bg-white p-6 border border-white/20">
                <div className="flex items-center justify-between mb-4">
                  <span className="text-xs font-bold text-gray-400 tracking-wider uppercase">NexusEdu Player</span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              { title: 'Q&A সাপোর্ট', desc: 'যেকোনো প্রশ্নের উত্তর পেতে আমাদের ফোরামে যুক্ত হও।' }
            ].map((feature, i) => (
